...
{
    public partial class ActivateSubscription : System.Web.UI.Page, IActivateSubscriberAccount
    {
        ActivateSubscriberAccountController Controller;
        protected void Page_Load(object sender, EventArgs e)
        {
            Controller = new ActivateSubscriberAccountController(this);
            if (!IsPostBack)
            {
        ...
        {
            Controller.OnActivate(txtActivationCode.Text);
        }

        protected void lbtnResendCode_Click(object sender, EventArgs e)
        {
            Controller.OnSendNewActivationCode();
        }
