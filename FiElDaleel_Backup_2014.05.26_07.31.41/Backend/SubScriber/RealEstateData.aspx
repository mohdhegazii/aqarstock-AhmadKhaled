        ...
        <telerik:RadTabStrip ID="rtsAddRealEstate" MultiPageID="rmpAddBusiness" AutoPostBack="True"
            ...
            <Tabs>
                <telerik:RadTab PageViewID="rpvMainData">
                    <TabTemplate>
                        <div class="WizardTab">
                            <asp:Image ID="Image1" CssClass="img-responsive" ImageUrl="~/images/MainData.png"
                                runat="server" />
                            <asp:Label ID="Label1" runat="server" Text="البيانات الاساسية"></asp:Label>
                        </div>
                    </TabTemplate>
                </telerik:RadTab>
                <telerik:RadTab PageViewID="rpvAddressData">
                    <TabTemplate>
                        <div class="WizardTab">
                            <asp:Image ID="Image1" CssClass="img-responsive" ImageUrl="~/images/Address.png"
                                runat="server" />
                ...
                <telerik:RadTab PageViewID="rpvAdvData" Selected="True">
                    <TabTemplate>
                        <div class="WizardTab">
                            <asp:Image ID="Image1" CssClass="img-responsive" ImageUrl="~/images/Additional.png"
                                runat="server" />
                            <asp:Label ID="Label1" runat="server" Text="بيانات أضافية"></asp:Label>
                        </div>
                    </TabTemplate>
                </telerik:RadTab>
                <telerik:RadTab PageViewID="rpvPhotos" Selected="True">
                  ...
                  <telerik:RadTab>
                        <TabTemplate>
                            <div class="WizardTab">
                                <asp:Image ID="Image1" CssClass="img-responsive" ImageUrl="~/images/View.png"
                                    runat="server" />
                        ...
                        <div class=" pull-right">
                            <div class="ContentItem row">
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 pull-right">
                                    <asp:Label ID="Label9" runat="server" Text="عنوان الاعلان عن العقار/الارض *" CssClass="control-label"></asp:Label>
                                </div>
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <asp:TextBox ID="txtTitle" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ValidationGroup="Save" CssClass="Validator"
                                        ControlToValidate="txtTitle" runat="server" Display="Dynamic" ErrorMessage="! من فضلك ادخل اسم العقار/الارض"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="ContentItem row">
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 pull-right">
                            ...
                            <div class="ContentItem row">
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 pull-right">
                                    <asp:Label ID="Label6" runat="server" Text=" كلمات دالة على العقار/الارض *" CssClass="control-label"></asp:Label>
                                </div>
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <telerik:RadAutoCompleteBox ID="txtKeywords" runat="server" CssClass="form-control"
                                 ...
                                 <div class="ContentItem row">
                                <asp:CheckBox ID="chkContactData" Text="استخدم بيانات الاتصال للنشاط" CssClass="Check" Checked="true" onclick="ChangeContactVisible(this);"
                                    runat="server" />
                            </div>
                ...
                <telerik:RadPageView CssClass="WizardPageView" ID="rpvAddressData" runat="server">
                    ...
                    <div class="Content row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pull-right">
                            ...
                            <div class="ContentItem">
                                <asp:Button ID="Button1" runat="server" CssClass="btn btn-lg" Text="حفظ" ValidationGroup="SaveAddress"
                                    OnClick="btnSave_Click" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pull-right">
                            <asp:Label ID="Label10" runat="server" Text="لاضافة موقع العقار/الارض انقر بالزر الايمن للفأرة"
                                CssClass="Note"></asp:Label>
                            ...
                            <div class="pull-right">
                                ...
                                <asp:ListView ID="rptCrieria" runat="server" DataKeyNames="ID" onitemdatabound="rptCrieria_ItemDataBound">
                                    <ItemTemplate>
                                        ...
                                        <div class="ContentItem row" id="divCheckbox" runat="server">
                             ...
                             <div class="ContentItem">
                            <asp:Button ID="Button2" runat="server" CssClass="btn btn-lg" Text="حفظ" ValidationGroup="SaveAdditionalData"
                                OnClick="btnSave_Click" />
                        </div>
                    </div>
                </telerik:RadPageView>
