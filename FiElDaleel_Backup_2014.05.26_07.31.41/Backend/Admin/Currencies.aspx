...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Content">
        <div class="ContentItem">
            <asp:Label ID="Label2" runat="server" Text="اسم العملة" CssClass="control-label"></asp:Label>
        ...
        <div class="ContentItem">
            <asp:GridView ID="gvCurrencies" runat="server" DataKeyNames="ID" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Name" HeaderText="اسم العملة" HeaderStyle-HorizontalAlign="Center"
