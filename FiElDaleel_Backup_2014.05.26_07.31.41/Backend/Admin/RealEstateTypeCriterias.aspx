...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Content">
        <div class="row">
            <div class="col-lg-4 pull-right">
                <div class="ContentItem row">
                   ...
                   <div class="ContentItem row">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 pull-right">
                        <asp:Label ID="Label3" runat="server" Text="النوع" CssClass="control-label"></asp:Label>
                    </div>
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="Save" CssClass="Validator"
                            ControlToValidate="ddlTypes" runat="server" ErrorMessage="!" Display="Dynamic"
                            InitialValue="0"></asp:RequiredFieldValidator>
                    </div>
                </div>
                ...
                <div class="ContentItem row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="Save" CssClass="Validator"
                            ControlToValidate="txtTitle" runat="server" ErrorMessage="!" Display="Dynamic"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="ContentItem row">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 pull-right">
                        <asp:Label ID="Label4" runat="server" Text="نوع القيمة" CssClass="control-label"></asp:Label>
                    </div>
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ValidationGroup="Save" CssClass="Validator"
                            ControlToValidate="ddlValueType" runat="server" ErrorMessage="!" Display="Dynamic"
                            InitialValue="0"></asp:RequiredFieldValidator>
                    </div>
                </div>
            </div>
        ...
        <div class="ContentItem">
            <asp:GridView ID="gvCriterias" runat="server" DataKeyNames="ID" AutoGenerateColumns="False"
                CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="Grid table .table-hover"
                AllowPaging="True" PageSize="20">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <Columns>
                    <asp:BoundField DataField="ID" HeaderText="Id" Visible="false" />
                    <asp:BoundField DataField="TypeTitle" HeaderText=" النوع" HeaderStyle-HorizontalAlign="Center"
                        HeaderStyle-CssClass="GridColumnHeader" />
                    <asp:BoundField DataField="Title" HeaderText=" الاسم" HeaderStyle-HorizontalAlign="Center"
                        HeaderStyle-CssClass="GridColumnHeader" />
                                 <asp:TemplateField  HeaderText=" نوع القيمة"  HeaderStyle-HorizontalAlign="Center"
                        HeaderStyle-CssClass="GridColumnHeader">
                        <ItemTemplate>
