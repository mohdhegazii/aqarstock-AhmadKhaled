...
namespace BrokerWeb
{
    public partial class Register : AqarPage,ILogin
    {
        ...
        public bool IsRegister
        {
            get
            {
                ...
                if (ViewState["IsRegister"] == null)
                    return false;
                else
                    return (bool)ViewState["IsRegister"];
            }
            set
            {
                ViewState["IsReqister"] = value;
            }
        }
        ...
        public void NotifyUser(Message Msg, BrokerDLL.MessageType Type)
        {
            ...
            if (Msg == Message.UsernameNotAvailable)
            {
                ...
                lblUserNameMsg.CssClass = "Error";
                lblUserNameMsg.Attributes.Add("style", "display:block");
            }
        ...
        protected void txtRegUserNamr_TextChanged(object sender, EventArgs e)
        {
            ...
            if (rgx.IsMatch(txtRegUserNamr.Text))
            {
        ...
        {
            Controller.OnLogin(txtLoginUserName.Text, txtLoginPassword.Text);
        }
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               // hdnIsRegister.Value = "true";
                //  Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "ShowRegister()", true);
                //   Page.RegisterStartupScript("Register", "ShowRegister()");
            }
        }
