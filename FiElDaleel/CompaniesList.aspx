<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompaniesList.aspx.cs"
    Inherits="BrokerWeb.CompaniesList" %>
...
<!-- End Google Tag Manager -->
    ...
    <meta charset="utf-8" />
     <title>عقار ستوك | محرك بحث عقارى | شقق وفيلات واراضى | للبيع والإيجار - شركات عقارية</title>
    <meta name="title" content="عقار ستوك | محرك بحث عقارى | شقق وفيلات واراضى | للبيع والإيجار - شركات عقارية" />
    ...
    <meta name='twitter:title' content="عقار ستوك | محرك بحث عقارى | شقق وفيلات واراضى | للبيع والإيجار - شركات عقارية" />
    ...
    <meta name='og:title' content="عقار ستوك | محرك بحث عقارى | شقق وفيلات واراضى | للبيع والإيجار - شركات عقارية" />
...
<!-- End Google Tag Manager (noscript) -->
	...
	<div id="divHeader" ng-include src="'parts/Header.htm'" onload="LoadHeader()">
        ...
        <div class="content">
            <div class="container">
                <div class="compenies col-md-8" ng-controller="CompanyListController">
                    <div class="Title">
                        <h4>
                            <span>الشركات العقارية</span></h4>
                    </div>
                    <div class="compeniesList">
                        <div class="compeny" ng-repeat="Company in Companies">
                        <a ng-href="/شركات_عقارية/{{Company.ID}}/{{Company.URL}}">
                            <div class="companyImg">
                                <img src="http://www.aqarstock.com/{{Company.Logo}}" alt="{{Company.Name}}" /></div>
                            <div class="companyDes">
                                ...
                                <div class="moreBtn">
                                    <span><a ng-href="/شركات_عقارية/{{Company.ID}}/{{Company.URL}}">تعرف على المزيد</a></span></div>
                            </div>
                            </a>
                        </div>
                    </div>
                    <div id="divListLoading" class="loader">
                        <img src="images/Frontend/loading2.gif" /></div>
                    <div class="pageController">
                        <div class="prevBtn" ng-click="PreviousPage()">
                        </div>
                        <div class="firstOne" style="display: none">
                            <a href="javascript:void(0);" ng-click="MoveTo(FirstPage)">{{FirstPage}}</a></div>
                        ...
                        <div id="divLastPage" class="dottes">
                            <span>...</span></div>
                        <div class="lastOne">
                            <a href="javascript:void(0);" ng-click="MoveTo(LastPage)">{{LastPage}}</a></div>
                ...
                <div id="div1" class="col-md-4" ng-include src="'parts/SideBar.htm'">
                </div>
