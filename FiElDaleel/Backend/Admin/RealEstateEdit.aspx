<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="RealEstateEdit.aspx.cs" Inherits="BrokerWeb.Backend.Admin.RealEstateEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script src="../../scripts/Map.js" type="text/javascript"></script>
        ...
        <link href="../../styles/jquery.fileupload.css" rel="stylesheet" type="text/css" />
        ...
        <div class="addProperty">
            ...
            <div class="addPropertyGroup">
                ...
                <div class="addPropertyInsideGroup">
                    ...
                    <div class="row labelRow">
                        <p>
                            إضافة صور للوحدة <span class="tinyNote">إختياري (إضافة الصور تحسن من فرصك في البيع)</span>
                        </p>
                    </div>
                    <div class="row">
                        <div class="aControl">
            ...
            <div class="addPropertyGroup">
                ...
                <div class="addPropertyInsideGroup">
                    ...
                    <div class="row">
                        <div class="aControl">
                            <asp:TextBox ID="txtTitle" runat="server" Width="20%" Height="100px"  TextMode="MultiLine" MaxLength="500" placeholder="شقة / فيلا / ارض ( نوع العقار ) للبيع / للأيجار [ تقسيط / كاش ]  بـــ ( اسم الحى ) – ( أهم المناطق بجواره )"></asp:TextBox>
                            <br />
                ...
                <div class="addPropertyInsideGroup">
                    <div class="row labelRow">
                        <p>
                            السعر <span class="tinyNote">ما هو السعر التقديري للبيع؟</span>
                        </p>
                    </div>
                    <div class="row">
                        <div class="aControl">
