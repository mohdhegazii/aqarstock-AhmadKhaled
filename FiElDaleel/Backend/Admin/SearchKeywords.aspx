<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="SearchKeywords.aspx.cs" Inherits="BrokerWeb.Backend.Admin.SearchKeywords" %>
            ...
            <div class="ContentItem">
                <asp:GridView ID="gvkeywords" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" CssClass="table table-striped table-bordered table-hover theGridTable rtlDirection" DataKeyNames="ID" OnPageIndexChanging="gvCountries_PageIndexChanging" PageSize="20">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Keywords" HeaderStyle-CssClass="GridColumnHeader" HeaderStyle-HorizontalAlign="Center" HeaderText="كلمة البحث" />
                        <asp:BoundField DataField="ParentKeyword" HeaderStyle-CssClass="GridColumnHeader" HeaderStyle-HorizontalAlign="Center" HeaderText="كلمة البحث الأساسية" />
                        <asp:TemplateField>
                            <ItemTemplate>
