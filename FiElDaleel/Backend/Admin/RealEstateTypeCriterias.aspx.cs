...
namespace BrokerWeb.Backend.Admin
{
    public partial class RealEstateTypeCriterias : System.Web.UI.Page, IRealEstateTypeCriteria
    {
        ...
        protected void gvCriterias_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            gvCriterias.PageIndex = e.NewPageIndex;
            gvCriterias.DataSource = Controller.OnNeedDatasource();
            gvCriterias.DataBind();
        }
    }
}