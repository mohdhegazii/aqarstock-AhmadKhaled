   ...
   <asp:HiddenField ID="hdnLat" runat="server" />
    ...
    <%--    <asp:Image ID="imgSold" CssClass="img-responsive SoldImage" ImageUrl="~/images/icons/sold.png"
        ...
        <div class="EditBusiness">
                ...
                ImageUrl="~/images/icons/Admin/Activate.png" onclick="imgActivate_Click"  />
            ...
            <asp:Image ID="Image3" ImageUrl="~/images/icons/Admin/suspend.png" Style="vertical-align:inherit;" runat="server" />
        </a>
               <asp:ImageButton ID="imgSold" runat="server"
                ImageUrl="~/images/icons/Admin/sold.png"   onclick="imgSold_Click"/>
                <asp:ImageButton ID="imgSetOffer" runat="server"
                ImageUrl="~/images/icons/Admin/Offer.png" onclick="imgSetOffer_Click"   />
                <asp:ImageButton ID="imgRemoveOffer" runat="server"
                ImageUrl="~/images/icons/Admin/removeOffer.png" onclick="imgRemoveOffer_Click"   />
                <asp:ImageButton ID="imgEdit" runat="server" ImageUrl="~/images/icons/Admin/edit.png" OnClick="imgEdit_Click" />
        </div>
    </div>
            ...
            <telerik:RadTabStrip ID="rtsAddBusiness" MultiPageID="rmpAddBusiness" AutoPostBack="true"
                ...
                <Tabs>
                    <telerik:RadTab PageViewID="rpvMap">
                        <TabTemplate>
                            <div class="WizardTab">
                                <asp:Image ID="Image1" CssClass="img-responsive" ImageUrl="~/images/icons/backend/address.png" runat="server" />
                    ...
                    <telerik:RadTab PageViewID="rpvPhotos">
                        <TabTemplate>
                            <div class="WizardTab">
                                <asp:Image ID="Image1" CssClass="img-responsive" ImageUrl="~/images/icons/backend/images.png"
                                    runat="server" />
