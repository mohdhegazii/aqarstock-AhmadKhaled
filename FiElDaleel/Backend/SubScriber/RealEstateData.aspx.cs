...
namespace BrokerWeb.Backend.SubScriber
{
    public partial class RealEstateData : System.Web.UI.Page, IRealEstateData
    {
        ...
        {
            Controller.OnSave();
            if (Mode == PageMode.EditNew || Mode == PageMode.Add)
            {
                rtsAddRealEstate.SelectedIndex = rtsAddRealEstate.SelectedIndex + 1;
                rmpAddBusiness.SelectedIndex = rmpAddBusiness.SelectedIndex + 1;
            }
        }
        ...
        public BrokerDLL.RealEstate FillRealEstateObject(RealEstate realestate)
        {
        ...
        public void UploadRealEstatePhoto(int Code)
        {
          //  throw new NotImplementedException();
        }


        public void BindPhotoList(List<RealEstatePhoto> Photos)
        {
           // throw new NotImplementedException();
        }
    }
