<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/SubScriber/SubscriberMaster.Master"
    ValidateRequest="false" AutoEventWireup="true" CodeBehind="ProjectData.aspx.cs"
    Inherits="BrokerWeb.Backend.SubScriber.ProjectData" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register Src="UserControls/ucProjectPhoto.ascx" TagName="ucProjectPhoto" TagPrefix="uc1" %>
<%@ Register Src="UserControls/ucProjectVedio.ascx" TagName="ucProjectVedio" TagPrefix="uc2" %>
<%@ Register Src="UserControls/ucProjectModel.ascx" TagName="ucProjectModel" TagPrefix="uc3" %>
<%@ Register Src="UserControls/ucProjectRealestate.ascx" TagName="ucProjectRealestate" TagPrefix="uc4" %>
