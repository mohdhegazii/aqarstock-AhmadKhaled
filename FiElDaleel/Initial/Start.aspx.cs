...
namespace BrokerWeb.Initial
{
    public partial class Start : System.Web.UI.Page
    {
        ...
        protected void btnActiveStatus_Click(object sender, EventArgs e)
        {
            ...
            Lookups.InsertActiveStatus("Migrated");
        ...
        protected void btnSaleType_Click(object sender, EventArgs e)
        {
            ...
            Lookups.InsertSaleType("للبيع او للايجار");
        ...
        protected void btnSuspendReasons_Click(object sender, EventArgs e)
        {
            ...
            Lookups.InserSusspendReasson("العقار مكرر");
            Lookups.InserSusspendReasson("البيانات غير كاملة");
        ...
        {
            Lookups.InsertRealEstateCategory("وحدات سكنية");
            Lookups.InsertRealEstateCategory("وحدات تجارية");
            Lookups.InsertRealEstateCategory("اراضى");
        }

        protected void btnAdPackage_Click(object sender, EventArgs e)
        {
            Lookups.InserAdPackage("Normal");
            Lookups.InserAdPackage("Payed");
            Lookups.InserAdPackage("SpecialPayed");
            Lookups.InserAdPackage("Partner");
            lblMsg.Text = "Packages is Created";
        }
    }
}